		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "HSD Repack",
									"targetURL": "#comsapparkerzwmhsdrepack-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapparkerzwmhsdrepack-display": {
								"semanticObject": "comsapparkerzwmhsdrepack",
								"action": "display",
								"description": "HSD Repack",
								"title": "HSD Repack",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.parker.zwmhsdrepack",
									"url": sap.ui.require.toUrl("com/sap/parker/zwmhsdrepack")
								}
							}
						}
					}
